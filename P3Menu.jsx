...
const ITEMS = [
  { id: "about",  label: "SOBRE MI",      href: "#about",  fontSize: 130, offsetX: 0,  offsetY: 0  },
  { id: "resume", label: "CURRICULUM",    href: "#resume", fontSize: 108, offsetX: 38, offsetY: -8 },
  { id: "github", label: "ENLACE GITHUB", href: "https://github.com/guillecordel", fontSize: 88, offsetX: 14, offsetY: -6 },
];
  ...
  return (
    <>
      ...
      <div className="p3-root">
        ...
        <div className="p3-bg-word">SISTEMA</div>
