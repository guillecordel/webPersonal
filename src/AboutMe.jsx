...
const REVEAL_CONTENT = [
  {
    upper: ["Guillermo Cortés", "3º Ingeniería Informática", "Universidad de Murcia"],
    lower: "futuro ingeniero enfocado en software, ciberseguridad e ia generativa",
  },
  {
    upper: [
      "Sistemas/Bajo Nivel: C, C++ y Java",
      "Web/Frontend: React.js, Next.js, JavaScript, TypeScript y Tailwind CSS",
      "Bases de datos: MySQL y Firebase",
    ],
    lower: "versatilidad activa para construir, depurar y escalar",
  },
  {
    upper: [
      "Profesor particular de ciencias e inglés",
      "Divulgador tecnológico en institutos de Murcia",
      "Contacto directo: guillecordel@gmail.com",
    ],
    lower: (
      <>
        linkedin: <a className="break-all" href="https://www.linkedin.com/in/guillermo-cort%c3%a9s-delgado-4653b833a" target="_blank" rel="noreferrer">https://www.linkedin.com/in/guillermo-cort%c3%a9s-delgado-4653b833a</a>
      </>
    ),
  },
];
...
const ROLES = [
  { text: "LIDER", color: "#e8c100", bg: "rgba(232,193,0,0.12)", border: "rgba(232,193,0,0.5)" },
  { text: "EQUIPO",  color: "#4a8fff", bg: "rgba(74,143,255,0.12)", border: "rgba(74,143,255,0.5)" },
  { text: "EQUIPO",  color: "#4a8fff", bg: "rgba(74,143,255,0.12)", border: "rgba(74,143,255,0.5)" },
];

const ITEMS = [
  {
    id: "twitch", label: "SOBRE MI", handle: "@guillecordel", href: "https://www.linkedin.com/in/guillermo-cort%C3%A9s-delgado-4653b833a", icon: "🎮", barIcon: icon1, bars: 1, newBars: [0], counts: ["03"],
    links: ["https://www.linkedin.com/in/guillermo-cort%C3%A9s-delgado-4653b833a"],
    stats: [
  ...
  {
    id: "instagram", label: "HABILIDADES", handle: "@guillecordel", href: "https://github.com/guillecordel", icon: "📷", barIcon: icon2, bars: 5, newBars: [1, 2], counts: ["C", "C++", "JAVA", "TS", "SQL"],
    links: ["https://github.com/guillecordel", "https://github.com/guillecordel?tab=repositories", "https://github.com/guillecordel/TiendaGbones", "https://web-test-iso.vercel.app/", "https://github.com/guillecordel/RedesPabheto"],
    stats: [
  ...
  {
    id: "tiktok", label: "EXPERIENCIA", handle: "@guillecordel", href: "mailto:guillecordel@gmail.com", icon: "🎵", barIcon: icon3, bars: 7, newBars: [0, 3, 5, 6], counts: ["STEM", "AULA", "GUIA", "PRO", "RED", "IA", "P3"],
    links: ["https://www.linkedin.com/in/guillermo-cort%C3%A9s-delgado-4653b833a", "https://github.com/guillecordel", "mailto:guillecordel@gmail.com", "https://murcia.dev/charlas-stem", "https://murcia.dev/talleres-ia", "https://murcia.dev/ciberseguridad-juvenil", "https://murcia.dev/ingenieria-cotidiana"],
    stats: [
...
return (
    <div id="menu-screen">
      ...
      {/* PANEL DE INFORMACIÓN (AQUÍ ESTÁ EL ERROR) */}
      {revealed && (
      ...
      <style>{`
        ...
        .sc-reveal-upper-bar-experience {
          padding-left: 80px;
        }
        ...
        {ITEMS.map((item, i) => (
          ...
          >
            ...
            <div className="sc-bar">
              <img className="sc-char" src={CHARS[i]} alt="retrato del personaje" />
      ...
      <div className={`sc-footer${mounted ? " mounted" : ""}`}>
        <div className="sc-footer-row"><span className="sc-footer-key">↑↓</span><span>SELECCIONAR</span></div>
        <div className="sc-footer-row"><span className="sc-footer-key">↵</span><span>REVELAR</span></div>
        <div className="sc-footer-row"><span className="sc-footer-key">ESC</span><span>VOLVER</span></div>
      </div>
    </div>
  );
}
