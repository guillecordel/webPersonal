...
const ITEMS = [
  { id: "about",   label: "SOBRE MI",        page: "about",   fontSize: 80, offsetX: 0,  offsetY: 0,  skew: -6,  skewY: 10  },
  ...
  { id: "socials", label: "PROYECTOS PERSONALES",  page: "socials", fontSize: 56, offsetX: 16, offsetY: 8,  skew: -3,  skewY: 5   },
];
  ...
  return (
    <>
      <style>{`
        ...
        .p3-stripe  { position:absolute; right:-10px; top:0; bottom:0; width:5px; background:#c4001a; z-index:10; pointer-events:none; }
        .p3-stripe2 { position:absolute; right:-1px; top:0; bottom:0; width:2px; background:rgba(245,122,139,0.22); z-index:10; pointer-events:none; }
