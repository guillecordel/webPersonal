...
const ITEMS = [
  {
    id: "twitch", label: "ARCANA EL MAGO", handle: "@guillecordel", href: "https://gbones.vercel.app", icon: "🎮", barIcon: icon1, bars: 3, newBars: [0, 2], counts: ["WEB", "NEXT", "FIRE"],
    links: ["https://gbones.vercel.app", "https://github.com/guillecordel/TiendaGbones", "https://www.linkedin.com/in/guillermo-cort%C3%A9s-delgado-4653b833a"],
    captions: ["Tienda Web Reactiva", "Creacion y gestion de plataforma", "Divulgacion STEM en institutos de Murcia"],
    stats: [
      { tag: "ARC", value: "MAGO", color: "#9147ff" },
      { tag: "ROL", value: "GUIA",  color: "#bf94ff" },
    ],
  },
  {
    id: "instagram", label: "ARCANA EL ERMITANO", handle: "@guillecordel", href: "https://github.com/guillecordel/RedesPabheto", icon: "📷", barIcon: icon2, bars: 3, newBars: [1], counts: ["JAVA", "TCP", "LAN"],
    links: ["https://github.com/guillecordel/RedesPabheto", "https://github.com/guillecordel", "https://www.linkedin.com/in/guillermo-cort%C3%A9s-delgado-4653b833a"],
    captions: ["Intercambio de archivos Java", "Sockets TCP en red local", "Conexion tecnica entre equipos"],
    stats: [
      { tag: "ARC", value: "ERMIT", color: "#e1306c" },
      { tag: "ROL", value: "ARQ",  color: "#f77737" },
    ],
  },
  {
    id: "tiktok", label: "ARCANA EL JUICIO", handle: "@guillecordel", href: "https://web-test-iso.vercel.app/", icon: "🎵", barIcon: icon3, bars: 3, newBars: [0, 2], counts: ["SPA", "JS", "TAIL"],
    links: ["https://web-test-iso.vercel.app/", "https://github.com/guillecordel/webTestISO", "https://www.linkedin.com/in/guillermo-cort%C3%A9s-delgado-4653b833a"],
    captions: ["Web Test ISO", "Evaluacion y conocimiento tecnico", "Contacto: guillecordel@gmail.com"],
    stats: [
      { tag: "ARC", value: "JUICIO", color: "#00f2ea" },
      { tag: "ROL", value: "LIDER",  color: "#ff0050" },
    ],
  },
];
...
export default function Socials() {
  ...
  return (
    <div id="menu-screen">
      ...
      <video src="/assets/main3.mp4" autoPlay loop muted playsInline />
      <style>{`
      ...
      <div className="sc-root" role="navigation">
        {ITEMS.map((item, i) => (
          <div
            ...
            onClick={() => {
              if (active === i) openLink(item.href);
              else setActive(i);
            }}
      ...
      {mounted && Array.from({ length: ITEMS[active].bars }).map((_, i) => (
        ...
        >
          {ITEMS[active].newBars.includes(i) && (
            <img className="sc-info-bar-new" src={newsign} alt="indicador de contenido nuevo" />
          )}
          <div className="sc-info-bar">
            <img className="sc-info-bar-icon" src={ITEMS[active].barIcon} alt="icono de red social" />
            <span className="sc-info-bar-text">{ITEMS[active].captions[i]}</span>
            <span className="sc-info-bar-box">NODO</span>
      ...
      <div className={`sc-footer${mounted ? " mounted" : ""}`}>
        ...
        <div className="sc-footer-row"><span className="sc-footer-key">↵</span><span>ABRIR</span></div>
